...
import { IResponseArtist, IResponseTrack, ISearchResult } from "../components/interfaces/apiInterfaces";
...
function ArtistsSearchPage({ setPlaylistsID, setRandomColor, searchKey }: ISearchPage) {
