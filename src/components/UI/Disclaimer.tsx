...
function Disclaimer() {
  return (
    <div className="disclaimer">
      ...
      <p>Unfortunately, not everything that was conceived was realized, although we tried very hard. But there are a number of objective reasons for this, and perhaps the main one is the Spotify Api, which we used to get information.</p>
      ...
      <p>Fourthly, Spotify Api only provides a 30-second preview of songs, and for some songs even it is not available.</p>
